...
SELECT pg_catalog.setval(pg_get_serial_sequence('word_grammar_compatibility', 'id'), MAX(id)) FROM word_grammar_compatibility;
SELECT pg_catalog.setval(pg_get_serial_sequence('word_grammar_requirements', 'id'), MAX(id)) FROM word_grammar_requirements;
